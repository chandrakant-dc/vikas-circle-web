                ...
                <div>
                    {
                        ...
                        <p className="text-[#545454] text-[14px]">No Active Course available</p>
                    }
                    {activeCourseList.map((item, i) => (<div key={`active-course-section-${i + 1}`} className="mb-8">
                        <div className="active-course-category-name">{item?.categoryName}</div>
