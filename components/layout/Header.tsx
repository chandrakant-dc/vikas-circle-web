				...
				>
					<NavbarItem>
						<Link
							color="foreground"
							href="/"
							className={`h-10 font-medium rounded-[10px] px-4 flex items-center justify-center ${pathname === "/" ? "bg-[#EEF9FF] text-[#0053DC]" : ""}`}
						>
							Home
						</Link>
					</NavbarItem>
					<NavbarItem>
						<Link
							color="foreground"
							href="/explore"
							className={`h-10 font-medium rounded-[10px] px-4 flex items-center justify-center ${pathname.includes("/explore") ? "bg-[#EEF9FF] text-[#0053DC]" : ""}`}
						>
							Explore
						</Link>
					</NavbarItem>
					...
					<NavbarItem>
						<Link
							color="foreground"
							href="/contact-us"
							className={`h-10 font-medium rounded-[10px] px-4 flex items-center justify-center ${pathname === "/contact-us" ? "bg-[#EEF9FF] text-[#0053DC]" : ""}`}
						>
							Contact
						</Link>
					</NavbarItem>
				...
				<NavbarMenu className="bg-white">
					<NavbarMenuItem>
						<Link
							...
							color="foreground"
							href="/"
							className={`h-10 text-[14px] sm:text-[16px] tracking-wider font-medium rounded-[10px] w-fit px-4 flex items-center justify-start ${pathname === "/" ? "bg-[#EEF9FF] text-[#0053DC]" : ""}`}
						>
							Home
						</Link>
					</NavbarMenuItem>
					<NavbarMenuItem>
						<Link
							...
							color="foreground"
							href="/explore"
							className={`h-10 text-[14px] sm:text-[16px] tracking-wider font-medium rounded-[10px] w-fit px-4 flex items-center justify-start ${pathname.includes("/explore") ? "bg-[#EEF9FF] text-[#0053DC]" : ""}`}
						>
							Explore
						</Link>
					</NavbarMenuItem>
					...
					<NavbarMenuItem>
						<Link
							...
							color="foreground"
							href="/contact-us"
							className={`h-10 text-[14px] sm:text-[16px] tracking-wider font-medium rounded-[10px] w-fit px-4 flex items-center justify-start ${pathname === "/contact-us" ? "bg-[#EEF9FF] text-[#0053DC]" : ""}`}
						>
							Contact
						</Link>
					</NavbarMenuItem>
