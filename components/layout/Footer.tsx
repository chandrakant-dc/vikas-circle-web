			...
			<div className="section-container flex items-center">
				<div className="flex items-start justify-between w-full footer-content-wrap">
					<div className="footer-info">
						<Image src={"/logo.png"} alt="blog-card-img" height={200} width={200} />
						<p>We understand the unique demands of the financial brokerage world. We connect
							exceptional talent with leading firms.</p>
