...
export default function HeroSection() {
	return <div className="hero-section-base">
		<div className="section-container flex items-center">
			<div className="hero-section-content-wrapper">
				...
				<div className="flex items-center gap-4 mt-8">
					<Link href={"/"} className="cta-primary">Start Learning <RightArrowIcon /></Link>
					<Link href={"/"} className="cta-default">View Pricing <RightArrowIcon /></Link>
				</div>
			</div>
		</div>
	</div>;
