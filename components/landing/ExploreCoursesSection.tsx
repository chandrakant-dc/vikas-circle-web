        ...
        <div className="explore-course-section-base">
            <div className="section-container flex flex-col justify-center">
                <div className="section-header-container mb-8">
                    ...
                    <p>Choose from a wide range of professional courses designed to accelerate your career growth</p>
                </div>
...
function ExploreCard() {
    return <div className="explore-card">
        <Image src={"/explore-card-bg-1.jpg"} alt="explore-card-img" height={200} width={200} />
